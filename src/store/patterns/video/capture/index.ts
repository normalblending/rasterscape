import {EdgeMode, SlitMode} from "./types";
import {randomZ, throttled} from "./helpers";
...
export class Capture {
    ...
    constructor(props) {
        const {canvasElId, videoElId, w, h, f, onNewFrame} = props;
        ...
        new P5(sketch => {
            ...
            sketch.draw = () => {
                ...
                console.log(performance.now() - time, sketch.pixels);
