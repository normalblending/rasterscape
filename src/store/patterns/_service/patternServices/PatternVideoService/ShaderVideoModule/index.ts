...
import { XYCutFunctionTypeToNumber, CameraAxisToNumber, XYArrayCutFunctionTypeToNumber } from './utils'
...
export class ShaderVideoModule {
    ...
    initShader = () => {
        ...
        this.initParamTexture(new Uint8Array(width * height * 4), width, height)
    ...
    createRotationMatrix(ANGLE, tx, ty, tz) {
    ...
    updateFuncParamsByType = {
        ...
        [FxyType.Array]: () => {
            ...
            this.gl.uniform1i(u_CFParamI3, typeParams.drawHeight)
        ...
        [ECFType.DEPTH]: (state: AppState) => {
            ...
            const patternId = params.items[0].patternId
            ...
            if (!this.paramTexture) {
                ...
                this.updateParamTexture(new Uint8Array(imageData.data.buffer))
            }
