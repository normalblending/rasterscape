        ...
        <div className={'video-offset'}>
            <svg width={width} height={height} style={{
                ...
                <text x={4} y={4}
                      alignmentBaseline={'hanging'}
                      fill={'blue'}
                      fontSize={TEXT_SIZE} fontFamily={'Times new roman'} fontStyle={'italic'}>{cameraAxis}
                </text>
            ...
            <HoverHideable
                className={'video-offset_x-handler'}
                button={''}>
                <ButtonNumberCF
            ...
            <HoverHideable
                className={'video-offset_y-handler'}
                button={''}>
                <ButtonNumberCF
            ...
            <HoverHideable
                className={'video-offset_z-handler'}
                button={''}>
                <ButtonNumberCF
